...
Only if you prepare a container image the installation of CC-Core is important. Take a look at the [Container Image](/docs/container-image) documentation for more information.
